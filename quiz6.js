let numberArr = [
  ...
  let checkGameState = (arr) => {
    if((JSON.stringify(arr) === finalState)){
        ...
        <h1>You Cleared All the rounds</h1>
        <p>To get the reward <span>Click the image</span></p>
        <img onclick="location.href='//127.0.0.1:5500/End.html'" src="https://www.biworldwide.ca/globalassets/how-do-you-win-with-incentives.jpg">
   </div>`
    }
  }
  ...
  let repaint = () => {
    willRepaintGame.then(function(){
      ...
      setTimeout(function(){ checkGameState(numberArr);
   }, 100);
    })
  }
